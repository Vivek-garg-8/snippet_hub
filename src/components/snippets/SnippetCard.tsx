...
const SnippetCard: React.FC<SnippetCardProps> = ({ snippet, onEdit }) => {
  ...
  const handleTogglePin = () => {
    ...
    toast.success(snippet.isPinned ? 'Snippet unpinned' : 'Snippet pinned');
  };
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex space-x-1">
            <button
              ...
              className={`p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 ${snippet.isPinned ? 'text-yellow-500' : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'
                }`}
